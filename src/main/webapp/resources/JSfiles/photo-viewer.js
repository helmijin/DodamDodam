...
var $frame = $('#photo-viewer .thumbnail-wrapper .thumbnail .centered');     // Container for image
...
$(document).on('click', '.sm-thum-list ul li .thumbnail-wrapper .thumbnail .centered a.thumb', function(e){ // When a thumb is clicked on
