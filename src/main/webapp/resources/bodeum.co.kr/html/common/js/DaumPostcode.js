        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                if (num == 1) { // 제1저자
                    ...
                    document.getElementById('w_postcode2').value = data.zonecode; //5자리 새우편번호 사용
                    document.getElementById('w_add1_2').value = fullRoadAddr;
                    document.getElementById('w_add2_2').focus();
                } else if (num == 3) { // 제3저자
