			...
			<div class="content">
				<div class="inner-contents bg_gray">
					<div class="section columnList">
						...
						<form role="form" method="post" action="/bodeum/edu/eduinsert"
							id="frm">
							<!-- 게시판 삽입 시작 -->
										...
										<table class="table2">
											<tr>
												...
												<td><input type="text" name="title" id="title"
													size="140" placeholder="제목을 입력해주세요." style="outline: 2px;"></td>
											</tr>
										</table>
								...
								$('.summernote').summernote({
									  ...
									  lang: "ko-KR"
										...
										<div class="btn">
											...
											<div>
												<a class="roundBtn whiteBtn"
													onclick="document.getElementById('frm').submit();">작성</a>
											</div>
										</div>
									</div>
									<!-- 게시판 삽입 종료 -->
